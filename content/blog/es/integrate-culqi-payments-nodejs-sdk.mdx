...
abstract: "Aprende a usar el paquete `culqi-nodejs` para tokenizar tarjetas, crear cargos únicos y configurar pagos recurrentes (planes y suscripciones) de forma sencilla y segura en tus aplicaciones Node.js."
